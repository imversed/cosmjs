...
[![npm version](https://img.shields.io/npm/v/@imversed/cli.svg)](https://www.npmjs.com/package/@imversed/cli)
...
```
$ npm install @imversed/cli --save-dev
$ ./node_modules/.bin/cosmjs-cli
```
...
```
$ npm install -g @imversed/cli
$ cosmjs-cli
```

## Getting started

1. Install `@imversed/cli` and run `cosmjs-cli` as shown above
