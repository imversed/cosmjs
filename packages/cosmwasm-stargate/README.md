# @imversed/cosmwasm-stargate

[![npm version](https://img.shields.io/npm/v/@imversed/cosmwasm-stargate.svg)](https://www.npmjs.com/package/@imversed/cosmwasm-stargate)

An SDK to build CosmWasm clients.

## Compatibility

| CosmWasm        | x/wasm    | @imversed/cosmwasm-stargate |
| --------------- | --------- | ------------------------- |
