import { StdFee } from "@imversed/amino";
import { Decimal, Uint53 } from "@imversed/math";
import { coins } from "@imversed/proto-signing";
...
export class GasPrice {
   ...
   * See `GasPrice` in @imversed/stargate for a more generic matcher.
   *
